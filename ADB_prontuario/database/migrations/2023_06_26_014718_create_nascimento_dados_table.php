...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('nascimento_dados', function (Blueprint $table) {
            ...
            $table->string('tempo_amamentacao_exclusiva')->nullable();
            $table->enum('ordem', ['Primeiro filho', 'Segundo filho', 'Terceiro filho', 'Quarto filho', 'Quinto filho', 'Sexto filho', 'Setimo filho', 'Oitavo filho', 'Nono filho', 'Decimo filho ou maior']);
