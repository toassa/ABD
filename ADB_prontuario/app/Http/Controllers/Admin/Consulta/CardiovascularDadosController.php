...
class CardiovascularDadosController extends Controller
{
	...
	$page = 'cadastrar';
        ...
        return view('site.paciente.consulta.cardiovascular_dados.index', compact('dados','dados_paciente', 'page'));
    }
    ...
    public function atualizar(Request $req, $num_registro, $num_USP)
    {
        ...
        $saude_cardiaca = json_encode($request['saude_cardiaca']);

        $dor_peito = json_encode($request['dor_peito']);

        $exames_doenca_coronariana = json_encode($request['exames_doenca_coronariana']);
