...
<div class="row g-3 needs-validation page page1">
    <div class="col-md-6">
        ...
        <select class="form-select" id="validationCustomSelectDefine" name="casos_ulceras" required>
    ...
    <div class="col-md-12" id="show_input">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="pele_seca_pe_d" name="alteracoes" value="pele_seca_pe_d">
                <label class="form-check-label" for="pele_seca_pe_d">Pele seca no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="pele_seca_pe_e" name="alteracoes" value="pele_seca_pe_e">
                <label class="form-check-label" for="pele_seca_pe_e">Pele seca no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="rachaduras_pe_d" name="alteracoes" value="rachaduras_pe_d">
                <label class="form-check-label" for="rachaduras_pe_d">Rachaduras no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="rachaduras_pe_e" name="alteracoes" value="rachaduras_pe_e">
                <label class="form-check-label" for="rachaduras_pe_e">Rachaduras no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="fissuras_pe_d" name="alteracoes" value="fissuras_pe_d">
                <label class="form-check-label" for="fissuras_pe_d">Fissuras no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="fissuras_pe_e" name="alteracoes" value="fissuras_pe_e">
                <label class="form-check-label" for="fissuras_pe_e">Fissuras no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="calosidade_pe_d" name="alteracoes" value="calosidade_pe_d">
                <label class="form-check-label" for="calosidade_pe_d">Calosidade no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="calosidade_pe_e" name="alteracoes" value="calosidade_pe_e">
                <label class="form-check-label" for="calosidade_pe_e">Calosidade no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="unhas_atroficas_micoticas_pe_d" name="alteracoes" value="unhas_atroficas_micoticas_pe_d">
                <label class="form-check-label" for="unhas_atroficas_micoticas_pe_d">Unhas atroficas ou micóticas no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="unhas_atroficas_micoticas_pe_e" name="alteracoes" value="unhas_atroficas_micoticas_pe_e">
                <label class="form-check-label" for="unhas_atroficas_micoticas_pe_e">Unhas atroficas ou micóticas no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="unhas_encravadas_pe_d" name="alteracoes" value="unhas_encravadas_pe_d">
                <label class="form-check-label" for="unhas_encravadas_pe_d">Unhas encravadas no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="unhas_encravadas_pe_e" name="alteracoes" value="unhas_encravadas_pe_e">
                <label class="form-check-label" for="unhas_encravadas_pe_e">Unhas encravadas no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="micose_interdigital_pe_d" name="alteracoes" value="micose_interdigital_pe_d">
                <label class="form-check-label" for="micose_interdigital_pe_d">Micose interdigital no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="micose_interdigital_pe_e" name="alteracoes" value="micose_interdigital_pe_e">
                <label class="form-check-label" for="micose_interdigital_pe_e">Micose interdigital no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="bolhas_pe_d" name="alteracoes" value="bolhas_pe_d">
                <label class="form-check-label" for="bolhas_pe_d">Bolhas no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="bolhas_pe_e" name="alteracoes" value="bolhas_pe_e">
                <label class="form-check-label" for="bolhas_pe_e">Bolhas no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="edema_pe_d" name="alteracoes" value="edema_pe_d">
                <label class="form-check-label" for="edema_pe_d">Edema no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="edema_pe_e" name="alteracoes" value="edema_pe_e">
                <label class="form-check-label" for="edema_pe_e">Edema no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="alteracao_coloracao_pe_d" name="alteracoes" value="alteracao_coloracao_pe_d">
                <label class="form-check-label" for="alteracao_coloracao_pe_d">Alteração de coloração no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="alteracao_coloracao_pe_e" name="alteracoes" value="alteracao_coloracao_pe_e">
                <label class="form-check-label" for="alteracao_coloracao_pe_e">Alteração de coloração no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="palidez_elevacao_pe_d" name="alteracoes" value="palidez_elevacao_pe_d">
                <label class="form-check-label" for="palidez_elevacao_pe_d">Palidez à elevação do pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="palidez_elevacao_pe_e" name="alteracoes" value="palidez_elevacao_pe_e">
                <label class="form-check-label" for="palidez_elevacao_pe_e">Palidez à elevação do pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="veias_dorsais_dilatadas_pe_d" name="alteracoes" value="veias_dorsais_dilatadas_pe_d">
                <label class="form-check-label" for="veias_dorsais_dilatadas_pe_d">Veias dorsais dilatadas no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="veias_dorsais_dilatadas_pe_e" name="alteracoes" value="veias_dorsais_dilatadas_pe_e">
                <label class="form-check-label" for="veias_dorsais_dilatadas_pe_e">Veias dorsais dilatadas no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="veias_dorsais_colabadas_pe_d" name="alteracoes" value="veias_dorsais_colabadas_pe_d">
                <label class="form-check-label" for="veias_dorsais_colabadas_pe_d">Veias dorsais colabadas no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="veias_dorsais_colabadas_pe_e" name="alteracoes" value="veias_dorsais_colabadas_pe_e">
                <label class="form-check-label" for="veias_dorsais_colabadas_pe_e">Veias dorsais colabadas no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="ausencia_pelos_pe_d" name="alteracoes" value="ausencia_pelos_pe_d">
                <label class="form-check-label" for="ausencia_pelos_pe_d">Ausência de pelos no pé D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="ausencia_pelos_pe_e" name="alteracoes" value="ausencia_pelos_pe_e">
                <label class="form-check-label" for="ausencia_pelos_pe_e">Ausência de pelos no pé E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="pe_quente_d" name="alteracoes" value="pe_quente_d">
                <label class="form-check-label" for="pe_quente_d">Pé quente D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="pe_quente_e" name="alteracoes" value="pe_quente_e">
                <label class="form-check-label" for="pe_quente_e">Pé quente E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="pe_frio_d" name="alteracoes" value="pe_frio_d">
                <label class="form-check-label" for="pe_frio_d">Pé frio D</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="pe_frio_e" name="alteracoes" value="pe_frio_e">
                <label class="form-check-label" for="pe_frio_e">Pé frio E</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="outros" name="alteracoes" value="outros">
