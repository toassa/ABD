...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomQuaisInfeccoes" value="{{ isset($rows->quais_infeccoes) ? $rows->quais_infeccoes : '' }}" name="quais_infeccoes" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomQualFatorEmocional" value="{{ isset($rows->qual_fator_emocional) ? $rows->qual_fator_emocional : '' }}" name="qual_fator_emocional" required>
    <div class="invalid-feedback">
