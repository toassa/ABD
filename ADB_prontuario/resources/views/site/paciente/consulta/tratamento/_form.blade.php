<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomMedicamentoDiabetes" value="{{ isset($rows->medicamento_diabetes) ? $rows->medicamento_diabetes : '' }}" name="medicamento_diabetes" required>
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomTiposInsulinas" value="{{ isset($rows->tipos_insulinas) ? $rows->tipos_insulinas : '' }}" name="tipos_insulinas" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomNomeInsulina" value="{{ isset($rows->nome_insulina) ? $rows->nome_insulina : '' }}" name="nome_insulina" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomFrequenciaInsulina" value="{{ isset($rows->frequencia_insulina) ? $rows->frequencia_insulina : '' }}" name="frequencia_insulina" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomDoseInsulina" value="{{ isset($rows->dose_insulina) ? $rows->dose_insulina : '' }}" name="dose_insulina" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomOrigemInsulinas" value="{{ isset($rows->origem_insulinas) ? $rows->origem_insulinas : '' }}" name="origem_insulinas" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomOrigemUtensilho" value="{{ isset($rows->origem_utensilho) ? $rows->origem_utensilho : '' }}" name="origem_utensilho" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="number" class="form-control" id="validationCustomQuantiaReusoSeringas" value="{{ isset($rows->quantia_reuso_seringas) ? $rows->quantia_reuso_seringas : '' }}" name="quantia_reuso_seringas" required>
    <div class="invalid-feedback">
