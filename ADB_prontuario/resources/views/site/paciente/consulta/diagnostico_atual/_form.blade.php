    ...
    <div class="col-md-12 ">
        ...
        <div class="row align-content">
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox15" name="sintomas[]" value="Polaciúria" {{ isset($dados->sintomas) && in_array('Polaciúria', $dados->sintomas) ? 'checked' : '' }}>
            ...
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox17" name="sintomas[]" value="Dificuldade de urinar" {{ isset($dados->sintomas) && in_array('Dificuldade de urinar', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox17">Dificuldade de urinar</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox18" name="sintomas[]" value="Urgência miccional" {{ isset($dados->sintomas) && in_array('Urgência miccional', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox18">Urgência miccional</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox19" name="sintomas[]" value="Dificuldade para ereção/secura vaginal" {{ isset($dados->sintomas) && in_array('Dificuldade para ereção/secura vaginal', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox19">Dificuldade para ereção/secura vaginal</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox20" name="sintomas[]" value="Diarreia frequente" {{ isset($dados->sintomas) && in_array('Diarreia frequente', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox20">Diarreia frequente</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox21" name="sintomas[]" value="Constipação (mais de 3 dias sem evacuar)" {{ isset($dados->sintomas) && in_array('Constipação (mais de 3 dias sem evacuar)', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox21">Constipação (mais de 3 dias sem evacuar)</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox22" name="sintomas[]" value="Perda de fezes sem sentir" {{ isset($dados->sintomas) && in_array('Perda de fezes sem sentir', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox22">Perda de fezes sem sentir</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox23" name="sintomas[]" value="Sente enjoo após alimentação" {{ isset($dados->sintomas) && in_array('Sente enjoo após alimentação', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox23">Sente enjoo após alimentação</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox24" name="sintomas[]" value="Empachamento pós comer" {{ isset($dados->sintomas) && in_array('Empachamento pós comer', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox24">Empachamento pós comer</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox25" name="sintomas[]" value="Tontura ou desmaio ao levantar" {{ isset($dados->sintomas) && in_array('Tontura ou desmaio ao levantar', $dados->sintomas) ? 'checked' : '' }}>
                <label class="form-check-label label_check" for="checkbox25">Tontura ou desmaio ao levantar</label>
            </div>
            
            <div class="col-md-4 form-check mb-3">
                <input type="checkbox" class="form-check-input" id="checkbox26" name="sintomas[]" value="Outros" {{ isset($dados->sintomas) && in_array('Outros', $dados->sintomas) ? 'checked' : '' }}>
