...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomQuaisComplicacoes" value="{{ isset($rows->quais_complicacoes) ? $rows->quais_complicacoes : '' }}" name="quais_complicacoes" placeholder="Insira quais complicações" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomCausaInternacao" value="{{ isset($rows->causa_internacao) ? $rows->causa_internacao : '' }}" name="causa_internacao" placeholder="Insira a causa da internação" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="number" class="form-control" id="validationCustomEpisodiosUltimoMes" value="{{ isset($rows->episodios_ultimo_mes) ? $rows->episodios_ultimo_mes : '' }}" name="episodios_ultimo_mes" placeholder="Insira a quantidade de episódios no último mês" required>
    <div class="invalid-feedback">
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustomAlimentoTratarHipoglicemia" value="{{ isset($rows->alimento_tratar_hipoglicemia) ? $rows->alimento_tratar_hipoglicemia : '' }}" name="alimento_tratar_hipoglicemia" placeholder="Insira o alimento utilizado para tratar hipoglicemia" required>
    <div class="invalid-feedback">
