...
<div class="col-md-12">
    ...
    <div class="row">
        ...
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="dislipidemia" name="doenca_cronica" value="Dislipidemia">
            <label class="form-check-label label_check" for="dislipidemia">Dislipidemia</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="hipertireoidismo" name="doenca_cronica" value="Hipertireoidismo">
            <label class="form-check-label label_check" for="hipertireoidismo">Hipertireoidismo</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="hipotireoidismo" name="doenca_cronica" value="Hipotireoidismo">
            <label class="form-check-label label_check" for="hipotireoidismo">Hipotireoidismo</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="nodulo_tireoide" name="doenca_cronica" value="Nódulo da tireoide">
            <label class="form-check-label label_check" for="nodulo_tireoide">Nódulo da tireoide</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="dpoc_asma" name="doenca_cronica" value="DPOC/asma">
            <label class="form-check-label label_check" for="dpoc_asma">DPOC/asma</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="nefropatia_diabetica" name="doenca_cronica" value="Nefropatia diabética">
            <label class="form-check-label label_check" for="nefropatia_diabetica">Nefropatia diabética</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="artrite_reumatoide" name="doenca_cronica" value="Artrite reumatoide">
            <label class="form-check-label label_check" for="artrite_reumatoide">Artrite reumatoide</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="outras_autoimunes" name="doenca_cronica" value="Outras doenças autoimunes">
            <label class="form-check-label label_check" for="outras_autoimunes">Outras doenças autoimunes</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="esteatose_hepatica" name="doenca_cronica" value="Esteatose hepática">
            <label class="form-check-label label_check" for="esteatose_hepatica">Esteatose hepática</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="doenca_periodontal" name="doenca_cronica" value="Doença periodontal">
            <label class="form-check-label label_check" for="doenca_periodontal">Doença periodontal</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="outros_condicoes" name="doenca_cronica" value="Outros">
...
<div class="col-md-12">
    ...
    <div class="row">
        ...
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="retinopatia_diabetica_tratada" name="ocular" value="Retinopatia diabética tratada">
            <label class="form-check-label label_check" for="retinopatia_diabetica_tratada">Retinopatia diabética tratada</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="catarata" name="ocular" value="Catarata">
            <label class="form-check-label label_check" for="catarata">Catarata</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="glaucoma" name="ocular" value="Glaucoma">
            <label class="form-check-label label_check" for="glaucoma">Glaucoma</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="pseudofascia" name="ocular" value="Pseudofáscia">
            <label class="form-check-label label_check" for="pseudofascia">Pseudofáscia</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="vitrectomia" name="ocular" value="Vitrectomia">
            <label class="form-check-label label_check" for="vitrectomia">Vitrectomia</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="laserterapia" name="ocular" value="Laserterapia">
            <label class="form-check-label label_check" for="laserterapia">Laserterapia</label>
        </div>
        <div class="col-md-4 form-check mb-3">
            <input class="form-check-input" type="checkbox" id="outros_condicoes_oculares" name="ocular" value="Outros">
